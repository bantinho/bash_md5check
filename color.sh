...
\t${BOLD}-r${RESET}\tRetain duplicate files in SOURCE folder. Default: delete them. \n\
...
\t${BOLD}-k${RESET}\tKeep unmatched files in SOURCE and don't move them to the import folder in TARGET \n\
